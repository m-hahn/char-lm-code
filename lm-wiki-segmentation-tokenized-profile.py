...
#plt.legend()
plt.show()
plt.savefig(FIGURES_HOME+"/segmentation-profile-pmis-"+args.language+".png")
plt.close()
...
#plt.legend()
plt.show()
plt.savefig(FIGURES_HOME+"/segmentation-profile-surprisals-"+args.language+".png")
plt.close()
...
#plt.legend()
plt.show()
plt.savefig(FIGURES_HOME+"/segmentation-profile-entropies-"+args.language+".png")
plt.close()
