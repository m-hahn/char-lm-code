...
parser.add_argument("--batchSize", type=int, default=random.choice([128, 128, 256,256,256, 256, 512]))
parser.add_argument("--char_embedding_size", type=int, default=random.choice([50, 200, 200, 200]))
...
parser.add_argument("--weight_dropout_hidden", type=float, default=random.choice([0.0, 0.02, 0.05, 0.05, 0.05, 0.1, 0.15, 0.2]))
...
parser.add_argument("--learning_rate", type = float, default= random.choice([2.8, 2.9, 3.0, 3.0, 3.1, 3.2, 3.3]))
parser.add_argument("--myID", type=int, default=random.randint(0,1000000000))
parser.add_argument("--sequence_length", type=int, default=random.choice([40, 50, 50, 50, 60, 80]))
parser.add_argument("--verbose", type=bool, default=False)
parser.add_argument("--lr_decay", type=float, default=random.choice([0.8, 0.85, 0.9, 0.92, 0.95, 0.98, 1.0]))
