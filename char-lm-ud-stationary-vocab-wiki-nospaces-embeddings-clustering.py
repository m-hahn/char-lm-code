...
named_modules = {"char_embeddings" : char_embeddings}
...
embeddings = char_embeddings.weight.data.cpu().numpy()
...
plt.show()
plt.savefig("/checkpoint/mhahn/figures/char-emb-clustering_"+args.load_from+".png")
plt.close()
