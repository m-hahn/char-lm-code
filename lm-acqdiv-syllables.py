...
#      
#
#   if len(x) > 2 and x[0] not in vowels and x[0] == x[1] and x[2] in vowels and (len(x) == 3 or x[3] in validCodas):
#       return True
#   if len(x) == 1:
#      return x in vowels
#   if len(x) == 2:
#      return x[0] not in vowels and x[1] in vowels
#   if len(x) == 3:
#      return x[0] not in vowels and x[1] in vowels and x[2] in validCodas
#   return False
