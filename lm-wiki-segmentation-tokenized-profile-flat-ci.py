...
#plt.legend()
plt.show()
plt.savefig(FIGURES_HOME+"/segmentation-profile-flattened-pmis-"+args.language+"-ci.pdf", bbox_inches='tight')
plt.close()
...
#plt.legend()
plt.show()
plt.savefig(FIGURES_HOME+"/segmentation-profile-flattened-surprisals-"+args.language+"-ci.pdf", bbox_inches='tight')
plt.close()
...
#plt.legend()
plt.show()
plt.savefig(FIGURES_HOME+"/segmentation-profile-flattened-entropies-"+args.language+"-ci.pdf", bbox_inches='tight')
plt.close()
