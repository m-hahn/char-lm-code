...
predictor = [a+b+c+d+e for a, b, c, d, e in zip(predictor, predictorShiftedP1, predictorShiftedP2, predictorShiftedM1, predictorShiftedM2)]
...
extractedLexicon = {}
currentWord = ""
for char, predicted in zip(chars_test, predictions):
   if predicted == 1:
