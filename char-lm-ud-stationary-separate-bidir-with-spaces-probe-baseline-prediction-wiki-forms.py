...
doChoiceList([".wasmacheich.", ".wasmachstich.",".wasmachtich."])
doChoiceList([".wasmachedu.", ".wasmachstdu.",".wasmachtdu."])
doChoiceList([".wasmacheer.", ".wasmachster.",".wasmachter."])





doChoiceList([".ichschlumme.", ".ichschlummt.",".ichschlummst."])
doChoiceList([".duschlumme.",".duschlummst.",".duschlummt."])
doChoiceList([".erschlumme.",".erschlummt.", ".erschlummst."])
